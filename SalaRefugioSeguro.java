...
public class SalaRefugioSeguro extends Sala {
    ...
    public void resolverCanto(int indice, Mochila mochila) {
        ...
        switch (indice) {
            case 0:
                Mensageiro.exibirMensagem("\nVocê fortifica o refúgio para proteger contra invasões. Resolva: Qual é o resultado da expressão 7 + 5 * 2?", 50);
                ...
                break;
            case 1:
                Mensageiro.exibirMensagem("\nVocê estoca mantimentos suficientes para todos os sobreviventes. Resolva: Se cada sobrevivente consome 2 litros de água por dia e você tem 10 sobreviventes, quantos litros de água são necessários para uma semana?\n", 50);
                ...
                break;
            case 2:
                Mensageiro.exibirMensagem("\nVocê coordena os sobreviventes para garantir a segurança de todos. Resolva: Qual é a fórmula para calcular a área de um círculo?\n", 50);
                resposta = Console.nextLine();
            ...
            case 8:
                Mensageiro.exibirMensagem("⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣠⣤⣶⣾⣶⣶⣦⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n" + //
                                        ...
                                        "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠱⡄⠀⠀⠀⠈⠻⣿⣶⠇⠀⢀⣀⠸⠀⠀⠀⠀⡼⢧⠀⢻⡄⢸⣿⢃⡼⠁⠀⢠⠋⢁⠀⠀⠀⠀⠀⠀\r\n" + //
                                        "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢦⡀⠀⠀⠀⡘⢦⠀⠀⠘⠯⠀⠀⡇⠀⢰⠃⠘⡄⠀⡇⢸⡏⡼⠀⠀⠀⠈⠃⠠⠀⠀⠀⠀⠀⣀", 2);
                Mensageiro.exibirMensagem("\nOla, preciso te dizer algo, A sua Sinuzite te salvou do virus zombie, logo percebi pelo nariz...", 50);
                ...
                Mensageiro.exibirMensagem("\nPreciso da sua zinuzite para terminar de desenvolver a cura para aqueles que são zumbie. Resolva o seguinte: Combine os ingredientes na proporção correta para criar a cura.\n" +
                        ...
                        "Qual é a proporção correta dos ingredientes para criar a cura (formato: 1:2:4)?\n", 50);
                resposta = Console.nextLine();
